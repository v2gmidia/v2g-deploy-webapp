...
| [`inicio-canonico-r5-17-09.md`](./inicio-canonico-r5-17-09.md) | 17/09/2026 | A rodada 5 da tela canônica do Início, na bancada `/exemplo/`: composição refeita em quatro faixas, os quatro momentos (preparando, concluiu, no ar do cliente de três meses, parado), "Voltar a anunciar" desabilitado com o motivo, e as três decisões de 16–17/09 registradas em `decisoes.md`. Entrega completa em `v2g-wireframes/ENTREGA-R5.md`. **As rodadas R1 a R4 (16/09) não tinham linha aqui**; estão em `v2g-wireframes/ENTREGA-INICIO.md` e `ENTREGA-INICIO-R4.md`. | **Sim, quatro, na §0.** A que trava: o momento "acabou de concluir" não tem fonte (DUVIDA-11). As outras: textos para o Gabriel, a pergunta do dia fora do parado, e três nomes para falar com gente no celular. |
| [`inicio-canonico-r5-b-17-09.md`](./inicio-canonico-r5-b-17-09.md) | 17/09/2026, noite | A resposta da R5 à auditoria visual (`v2g-wireframes/AUDITORIA-R5.md`): a conclusão sem "Otimizar ✓", o parado com a âncora só da ação, a pergunta do dia sem a sobra de 60px e sem vazio à direita, as barras legíveis no escuro. Tabela achado por achado em `v2g-wireframes/ENTREGA-R5-B.md`. | **Sim, quatro, na §0.** A que decide: o B2 foi discordado em parte, porque a saída que funciona como principal inverte a decisão de 16/09 (DUVIDA-15). As outras: "Otimizar" na partição de produção, três textos de produção não tocados, e copy para o Gabriel. |
